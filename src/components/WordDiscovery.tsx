        ...
        <div className="flex w-full sm:w-auto items-center gap-1.5 overflow-x-auto no-scrollbar pb-1 sm:pb-0">
          ...
          <div className="flex items-center gap-1 shrink-0 pr-2">
            <button
              ...
              className="flex h-7 w-8 items-center justify-center rounded-lg bg-secondary text-secondary-foreground hover:bg-secondary/80 transition-colors disabled:opacity-30 shrink-0"
              title="Previous"
            >
              <ChevronLeft size={14} />
            </button>
            ...
            <button
              ...
              className="flex h-7 items-center gap-1.5 rounded-lg bg-secondary text-secondary-foreground hover:bg-secondary/80 px-3 font-mono text-[10px] font-bold uppercase transition-colors disabled:opacity-30 shrink-0"
            >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <button
                ...
                className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl transition-all shadow-md ${isAlreadySaved
